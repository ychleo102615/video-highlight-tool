...
// ❌ 錯誤：end 早於 start
const invalidRange = new TimeRange(TimeStamp.fromSeconds(30), TimeStamp.fromSeconds(10)); // 拋出 Error
```
...
// 按時間順序獲取選中的句子
const selectedSentences = highlightService.getSelectedSentences(highlight, transcript, 'time');
